...
const Card = props => (
  <div className="card-component">
    <a className="card-img-container" target="_blank" rel="noopener noreferrer" href={props.url}>
    ...
    <a className="github-icon-container" target="_blank" rel="noopener noreferrer" href={props.githubUrl}>
